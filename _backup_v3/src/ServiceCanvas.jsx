...
const label = (ctx, col, size = 11) => {
  ctx.font = `${size}px "Bricolage Grotesque", system-ui, sans-serif`
...
export default function ServiceCanvas({ kind, theme }) {
  ...
  return <canvas ref={ref} className="service-canvas" aria-hidden="true" />
}
